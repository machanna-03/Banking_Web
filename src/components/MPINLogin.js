...
const MPINLogin = () => {
  ...
  const handleSubmit = () => {
    const storedMpin = cookies.userMPIN;
    ...
    if (storedMpin !== mpin) {
      showSnackbar("Incorrect MPIN. Please try again.", "error");
      return;
    }

    showSnackbar("MPIN validated successfully!", "success");
  ...
  return (
    ...
    >
      ...
      />
      <Box sx={{ maxWidth: 400,}}>
      <Typography variant="h5" fontWeight="bold" sx={{ marginBottom: 2,textAlign:"center" }}>
        Enter Your MPIN
      </Typography>
      <Typography sx={{ margin: "10px 0", color: "grey.700" }}>
        Please enter your existing 4-digit MPIN.
      </Typography>
